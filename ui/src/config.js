/* Tunables. Every magic number in the layout lives here. */
...
export const FONT_LBL = '11px Inter, -apple-system, sans-serif';
export const FONT_BR  = '600 12px Inter, -apple-system, sans-serif';
